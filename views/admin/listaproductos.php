...
$auth = new Auth();
$Accion = "INGRESO";
$Descripcion = "INGRESO AL MODULO DE PRODUCTOS";
			...
			<div class="full-box page-header">
				...
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						...
						<a target="blank" href='reporteProducto' class="btn btn-danger btn_new_cliente"><i class="fa fa-file-pdf-o"></i> Reporte</a>
					</li>
				</ul>	
			</div>
