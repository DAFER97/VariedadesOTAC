...
define("DB_USER", 'root');
define("DB_PASSWORD", '');
define("DB_NAME", 'db_variedadesotaci');
define("DB_HOST", 'localhost');
define("BACKUP_DIR", 'myphp-backup-files'); // Comment this line to use same script's directory ('.')
define("BACKUP_FILE", 'myphp-backup-db_variedadesotaci-20210420_085527.sql'); // Script will autodetect if backup file is gzipped based on .gz extension
define("CHARSET", 'utf8');
